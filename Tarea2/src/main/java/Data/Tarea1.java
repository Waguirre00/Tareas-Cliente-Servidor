...
public class Tarea1 {
    ...
    public static void main(String[] args) {
        ...
        MyVehiculoMoto.MovimientoAtras();
        ...
        MyVehiculoCamion.MovimientoAtras();
        ...
        MyVehiculoHelicoptero.Rotando();
        MyVehiculoHelicoptero.MovimientoAtras();
